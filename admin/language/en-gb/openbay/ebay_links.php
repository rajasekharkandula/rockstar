...
$_['error_subtract_setting']        = 'This product is set not to subtract stock in RockStar.';
...
$_['text_link_desc2']               = 'For each item that is updated the local stock (the stock available in your RockStar store) will update your eBay listing';
...
$_['text_text_linked_desc']         = 'Linked items are RockStar items that have a link to an eBay listing.';
$_['text_text_unlinked_desc']       = 'Unlinked items are listings on your eBay account that do not link to any of your RockStar products.';
