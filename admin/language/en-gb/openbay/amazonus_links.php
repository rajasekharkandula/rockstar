...
$_['text_desc2'] 					= 'For each item that is updated the local stock (the stock available in your RockStar store) will update your Amazon listing';
$_['text_desc3']                    = 'You can link items manually by entering Amazon SKU and product name or load all unlinked products and then enter amazon SKUs. (Uploading products from RockStar to Amazon will automatically add links)';
