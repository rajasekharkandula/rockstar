            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
                    ...
                    <?php } ?>
					<?php if ($layout_module['position'] == 'trending') { ?>
                    <option value="trending" selected="selected"><?php echo $text_trending; ?></option>
                    <?php } else { ?>
                    <option value="trending"><?php echo $text_trending; ?></option>
                    <?php } ?>
                  </select></td>
