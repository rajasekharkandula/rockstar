...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['help_compare'] = $this->language->get('help_compare');
		...
		if (isset($this->request->post['config_product_compare'])) {
			$data['config_product_compare'] = $this->request->post['config_product_compare'];
		} else {
			$data['config_product_compare'] = $this->config->get('config_product_compare');
		}
